...
6. Edit file ./nginx/nginx.conf <br>
- Tạo thư mục nginx: **mkdir ./nginx*
-  Mở file nginx.conf để soạn thảo: **nano ./nginx/nginx.conf*
<img width="644" height="514" alt="image" src="https://github.com/user-attachments/assets/8c456b65-a18e-459d-951b-3be5b5d0d574" /> <br>
